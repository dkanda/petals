...
from heliopetals import AutoDistributedConfig
from heliopetals.server.throughput import measure_compute_rps
from heliopetals.utils.convert_block import QuantType
from heliopetals.utils.misc import DUMMY, is_dummy
from heliopetals.utils.packaging import pack_args_kwargs, unpack_args_kwargs
...
def test_bnb_not_imported_when_unnecessary():
    ...
    If this test fails, please change your code to import bitsandbytes and/or heliopetals.utils.peft
    ...
    subprocess.check_call([sys.executable, "-c", "import heliopetals, sys; assert 'bitsandbytes' not in sys.modules"])
