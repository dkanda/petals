...
import heliopetals
from heliopetals.constants import DTYPE_MAP, PUBLIC_INITIAL_PEERS
from heliopetals.data_structures import CHAIN_DELIMITER, UID_DELIMITER, ModelInfo, ServerInfo, ServerState, parse_uid
from heliopetals.server import block_selection
from heliopetals.server.backend import TransformerBackend, merge_inference_pools_inplace
from heliopetals.server.block_utils import get_block_size, resolve_block_dtype
from heliopetals.server.from_pretrained import load_pretrained_block
from heliopetals.server.handler import TransformerConnectionHandler
from heliopetals.server.memory_cache import MemoryCache
from heliopetals.server.reachability import ReachabilityProtocol, check_direct_reachability, validate_reachability
from heliopetals.server.throughput import get_dtype_name, get_server_throughput
from heliopetals.utils.auto_config import AutoDistributedConfig
from heliopetals.utils.convert_block import QuantType, check_device_balance, convert_block
from heliopetals.utils.dht import declare_active_modules, get_remote_module_infos
from heliopetals.utils.misc import get_size_in_bytes
from heliopetals.utils.ping import PingAggregator
from heliopetals.utils.random import sample_up_to
from heliopetals.utils.version import get_compatible_model_repo
...
class Server:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.server_info = ServerInfo(
            ...
            version=heliopetals.__version__,
    ...
    def _choose_num_blocks(self) -> int:
        ...
        if self.adapters:
            # Delay import of heliopetals.utils.peft to avoid unnecessary import of bitsandbytes
            from heliopetals.utils.peft import estimate_adapter_memory_per_block
