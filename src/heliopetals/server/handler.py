...
import heliopetals
from heliopetals.data_structures import CHAIN_DELIMITER, UID_DELIMITER, Handle, ModuleUID
from heliopetals.server.backend import TransformerBackend
from heliopetals.server.block_functions import iterate_rpc_inference, run_rpc_backward, run_rpc_forward
from heliopetals.server.task_prioritizer import DummyTaskPrioritizer, TaskPrioritizerBase
            ...
            try:
                ...
                async with self._allocate_cache(
                    ...
                    async for output_tensors, can_push, step_metadata in iterate_rpc_inference(
                        ...
                        peer_id=context.remote_peer_id,
                    ):
                        if can_push:
