...
from heliopetals.data_structures import InferenceMetadata
from heliopetals.server.memory_cache import MemoryCache
from heliopetals.server.task_pool import PrioritizedTaskPool
from heliopetals.utils.misc import get_size_in_bytes, is_dummy
...
class TransformerBackend(ModuleBackend):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        import heliopetals.utils.peft as _peft_module
