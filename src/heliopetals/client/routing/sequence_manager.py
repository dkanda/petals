...
from heliopetals.client.routing.sequence_info import RemoteSequenceInfo
from heliopetals.client.routing.spending_policy import NoSpendingPolicy
from heliopetals.data_structures import ModuleUID, RemoteSpanInfo, ServerState
from heliopetals.server.handler import TransformerConnectionHandler
from heliopetals.utils.dht import get_remote_module_infos
...
class SequenceManagerConfig(ClientConfig):
    def __init__(self, *args, **kwargs):
        warnings.warn(
            "heliopetals.client.routing.SequenceManagerConfig has been moved to heliopetals.ClientConfig. "
...
class RemoteSequenceManager:
    ...
    def get_request_metadata(
        ...
        :param args_structure: the structure of flattened tensors from pack_args_kwargs in heliopetals.utils.packaging
...
class MissingBlocksError(RuntimeError):
    def __init__(self, block_indices: Union[int, Sequence[int]]):
        super().__init__(
            ...
            f"You can check the public swarm's state at https://health.heliopetals.dev "
            f"If there are not enough servers, please connect your GPU: "
            f"https://github.com/bigscience-workshop/heliopetals#connect-your-gpu-and-increase-heliopetals-capacity "
        )
