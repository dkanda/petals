...
from heliopetals.client.lm_head import LMHeadConfig
from heliopetals.client.ptune import PTuneConfig
...
class DistributedBloomConfig(BloomConfig, ClientConfig, PTuneConfig, LMHeadConfig):
    ...
    def from_pretrained(
        ...
        if loading_from_repo and dht_prefix is None:
            # We need "-heliopetals" for backward compatibility with Petals < 1.2.0
            dht_prefix = str(model_name_or_path) + "-heliopetals"
