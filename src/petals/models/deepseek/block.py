...
class WrappedDeepseekBlock(DeepseekV3DecoderLayer):
    ...
    def _reorder_cache_from_bloom(
        ...
        key_states = key_states.view(
            batch_size, self.self_attn.num_key_value_heads, seq_length, self.self_attn.q_head_dim
        )
        value_states = value_states.view(
            batch_size, self.self_attn.num_key_value_heads, seq_length, self.self_attn.v_head_dim
        )
