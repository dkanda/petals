...
class PTuneMixin:
    ...
    def get_prompt(self, batch_size):
        ...
        if self.config.tuning_mode == "deep_ptune":
            ...
            # Prepend a zero-padding tensor for the first layer to maintain compatibility
            # with RemoteSequential logic, as the first layer's prompt is concatenated
            # to the input via prompt_embeddings.
