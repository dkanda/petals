...
class PTuneMixin:
    ...
    def get_prompt(self, batch_size):
        ...
        if self.config.tuning_mode == "deep_ptune":
            ...
            # Prepend a zero padding tensor for the first layer (which uses prompt_embeddings)
            # This maintains compatibility with RemoteSequential which expects num_hidden_layers prompts
            padding = torch.zeros(
