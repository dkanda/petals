...
class PTuneMixin:
    ...
    def get_prompt(self, batch_size):
        ...
        if self.config.tuning_mode == "deep_ptune":
            ...
            # Prepend a zero-padding tensor for the first layer (which is handled by `prompts`)
            # to maintain compatibility with RemoteSequential logic that expects `num_hidden_layers` tensors.
