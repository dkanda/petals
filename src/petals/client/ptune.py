...
class PTuneMixin:
    ...
    def get_prompt(self, batch_size):
        ...
        if self.config.tuning_mode == "deep_ptune":
            ...
            # The first layer uses `prompts` (which is concatenated to the input).
            # The remaining layers use `intermediate_prompts`.
            # To maintain compatibility with RemoteSequential logic, we prepend a zero-padding tensor for the first layer.
