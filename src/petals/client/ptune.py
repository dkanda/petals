...
class PTuneMixin:
    ...
    def get_prompt(self, batch_size):
        ...
        if self.config.tuning_mode == "deep_ptune":
            ...
            # The first layer prompt is concatenated to the input via prompt_embeddings.
            # We add a zero-padding tensor for the first layer to make it compatible with RemoteSequential.
