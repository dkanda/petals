...
def main():
    ...
    auth_group.add_argument(
        ...
        const=True,
        default=None,
        help="Hugging Face hub auth token. Pass --token with no argument to use token saved by `huggingface-cli login`.",
    )
    auth_group.add_argument(
        "--use_auth_token",
        action="store_true",
        dest="token",
        help="Deprecated: use --token instead. Reads token saved by `huggingface-cli login`",
    )
