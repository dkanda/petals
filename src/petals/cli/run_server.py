...
def main():
    ...
    basic_group.add_argument("--token", type=str, nargs='?', const=True, default=None,
                       help="Hugging Face hub auth token. "
                            "Use the flag without a value to read token saved by `huggingface-cli login`.")
