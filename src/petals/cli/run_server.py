...
def main():
    ...
    basic_group.add_argument("--token", nargs='?', const=True, default=None, help="Hugging Face hub auth token. If passed without a value, reads token saved by `huggingface-cli login`")
