...
*   **Goal**: Fix the Deep P-Tuning implementation and add unit tests.
*   **Implementation**:
    *   [x] Fix `intermediate_prompt_embeddings` to use `num_hidden_layers - 1` in `src/petals/client/ptune.py`.
    *   [x] Create `tests/test_ptune.py` and implement unit tests.
