...
*   **Deep P-Tuning Intermediate Prompts**:
    *   [x] Fixed the shape of `intermediate_prompt_embeddings` to use `num_hidden_layers - 1` instead of `num_hidden_layers` in `src/petals/client/ptune.py` to accurately reflect the deep p-tuning architecture.
