...
*   **Goal**: Resolve code-level inline TODO comments.
*   **Implementation**:
    *   [x] Fix `src/petals/client/ptune.py` to correctly size `intermediate_prompts` and remove `# TODO: should be num_hidden_layers - 1`.
