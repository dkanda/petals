...
## 8. Miscellaneous [DONE]
*   **Goal**: Resolve miscellaneous inline TODOs.
*   **Implementation**:
    *   [x] Fix `deep_ptune` intermediate prompt shape by changing `num_hidden_layers` to `num_hidden_layers - 1` in `src/petals/client/ptune.py`.
