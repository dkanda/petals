...
## 8. Prompt Tuning Fixes (High Priority) [DONE]
*   **Goal**: Fix embedding size and prompt logic for deep_ptune.
*   **Implementation**:
    *   [x] Fix intermediate prompt embeddings size and layer iteration in `src/petals/client/ptune.py`.
