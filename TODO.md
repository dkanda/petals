...
## 8. Deep P-Tuning Layer Adjustment (High Priority) [DONE]
*   **Goal**: Adjust deep p-tuning to only create intermediate prompts for hidden layers after the first layer.
*   **Implementation**:
    *   [x] Modify `src/petals/client/ptune.py` to use `num_hidden_layers - 1` for intermediate prompts and pad appropriately.
