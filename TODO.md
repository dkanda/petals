...
*   **Goal**: Fix missing deep_ptune num_hidden_layers intermediate prompt bug.
*   **Implementation**:
    *   [x] Fix deep_ptune intermediate prompts size calculation (`num_hidden_layers - 1`) in `src/petals/client/ptune.py`.
