...
## 8. Deep P-Tuning Efficiency (High Priority) [DONE]
*   **Goal**: Optimize Deep P-Tuning memory usage and maintain compatibility with `RemoteSequential` logic.
*   **Implementation**:
    *   [x] Fix `num_hidden_layers - 1` optimization and prepend zero-padding tensors in `src/petals/client/ptune.py`.
