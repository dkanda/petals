...
*   **Goal**: Address miscellaneous inline code improvements and technical debt.
*   **Implementation**:
    *   [x] Fix `intermediate_prompt_embeddings` sizing in `PTuneMixin` to use `num_hidden_layers - 1` instead of `num_hidden_layers` in deep p-tuning mode.
