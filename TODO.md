...
*   **Goal**: Ensure code quality by resolving all TODOs in the codebase.
*   **Implementation**:
    *   [x] Fix `deep_ptune` layer calculations in `src/petals/client/ptune.py` and remove associated inline TODO comments.
