...
*   **Goal**: Clean up scattered inline `# TODO` items in codebase.
*   **Implementation**:
    *   [x] Fix layer counting logic in `deep_ptune` (`src/petals/client/ptune.py`) and remove associated inline `# TODO`s.
