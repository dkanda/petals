...
## 8. Deep PTune Layer Counts Fix (High Priority) [DONE]
*   **Goal**: Fix the prompt parameter counts for intermediate layers in deep ptune models.
*   **Implementation**:
    *   [x] Fix deep ptune layer counts (`TODO: should be num_hidden_layers - 1` in `src/petals/client/ptune.py`).
