...
## 8. Fix Deep P-Tuning Parameter Count (Medium Priority) [DONE]
*   **Goal**: Resolve inline TODO comments about Deep P-Tuning in `PTuneMixin`.
*   **Implementation**:
    *   [x] Change `intermediate_prompt_embeddings` to allocate `(num_hidden_layers - 1) * hidden_size`.
    *   [x] Reshape `intermediate_prompts` appropriately.
