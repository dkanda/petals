...
*   **Goal**: Resolve inline TODOs in `src/petals/client/ptune.py`.
*   **Implementation**:
    *   [x] Update `num_hidden_layers` to `num_hidden_layers - 1` for `intermediate_prompts` and remove inline `# TODO` comments.
