...
*   **Goal**: Resolve inline TODOs in the codebase.
*   **Implementation**:
    *   [x] Update `intermediate_prompt_embeddings` initialization and reshaping to use `num_hidden_layers - 1` instead of `num_hidden_layers` in `src/petals/client/ptune.py`.
