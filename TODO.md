...
*   **Goal**: Fix the hidden layers count for deep ptune in PTuneMixin.
*   **Implementation**:
    *   [x] Fixed `intermediate_prompt_embeddings` to use `num_hidden_layers - 1`.
    *   [x] Fixed `intermediate_prompts.view` shape to use `num_hidden_layers - 1`.
