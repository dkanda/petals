...
## 8. Deep P-Tuning Fix
*   [x] Update `init_prompts` to use `(config.num_hidden_layers - 1) * config.hidden_size`.
*   [x] Update `get_prompt` to prepend a zero padding tensor for the first layer's prompt.
