...
*   **Goal**: Fix deep p-tuning intermediate prompt shapes.
*   **Implementation**:
    *   [x] Fix `intermediate_prompts` tensor shape in `src/petals/client/ptune.py`.
    *   [x] Add unit test for deep p-tuning in `tests/test_ptune.py`.
