...
*   **Goal**: Resolve ptune TODOs.
*   **Implementation**:
    *   [x] Fix intermediate prompt embedding shape to use `num_hidden_layers - 1` in `src/petals/client/ptune.py`.
    *   [x] Add unit testing for deep_ptune.
