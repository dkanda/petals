...
## 8. Miscellaneous (High Priority) [DONE]
*   **Goal**: Address unresolved TODOs in the codebase.
*   **Implementation**:
    *   [x] Fix `deep_ptune` intermediate prompt embeddings dimensionality in `src/petals/client/ptune.py` by subtracting 1 from `num_hidden_layers`.
