...
*   **Goal**: Clean up miscellaneous TODO items in the codebase.
*   **Implementation**:
    *   [x] Fix ptune intermediate prompt layer counting in `src/petals/client/ptune.py` and write unit test.
